...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (session.Process?.ProcessName == "Minecraft.Windows")
                {
                                    ...
                                    if (ScrollReject == 8)
                                    {
                                        ...
                                        if (RodHealth == (NumericUpDown1.Value - 1))
                                        {
                                            if (checkBox5.Checked == true)
                                            {
                                                ...
                                                //  RIGHTUP
                                                //  Terminate Minecraft.Windows
                                                foreach (System.Diagnostics.Process myProc in System.Diagnostics.Process.GetProcesses())
                                                {
                                                    if (myProc.ProcessName == "Minecraft.Windows")
                                                    {
                                                        myProc.Kill();
                                                    }
                                                }
            ...
            //  Look For Minecraft.Windows.exe
            if (checkBox8.Checked == false)
            {
                ...
                checkBox5.Checked = false;
                checkBox6.Checked = false;
                MessageBox.Show("The Minecraft.Windows.exe Process Was Stoped!", "Minecraft Auto-Fishing Bot v" + VersionNumber, MessageBoxButtons.OK, MessageBoxIcon.Error);
