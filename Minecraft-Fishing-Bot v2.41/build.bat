::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
::Install MinecraftFishingBot Via MSBuild                                               ::
::Gihub https://github.com/RussDev7/Undetected-External-Auto-Fishing-Bot-For-Minecraft  ::
::Devoloped, Maintained, And Sponsored By D.RUSS#2430                                   ::
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
@ECHO OFF

Rem | Set Params
Set "VersionPrefix=2.4.0.0"
Set "filename=MinecraftFishingBot-%VersionPrefix%"

Rem | Install SLN Under x64 Profile
C:\Windows\Microsoft.NET\Framework64\v4.0.30319\MSBuild.exe "Minecraft-Fishing-Bot.sln" /p:Configuration=Release /p:Platform=x64"
