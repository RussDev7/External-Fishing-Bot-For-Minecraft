...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void Timer1_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (session.Process?.ProcessName == "javaw")
                {
            ...
            if (checkBox8.Checked == false)
            {
                ...
                checkBox5.Checked = false;
                checkBox6.Checked = false;
                MessageBox.Show("The javaw.exe Process Was Stoped!", "Minecraft Auto-Fishing Bot v" + VersionNumber, MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (System.IO.Directory.Exists("C:\\Program Files\\Java"))
            {
                ...
                foreach (DirectoryInfo dir in directories)
                {
                    ...
                    {
                        JreVersion = (JreVersion + ("-" + dir.Name));
                    }

                }

                Label9.Text = JreVersion;
